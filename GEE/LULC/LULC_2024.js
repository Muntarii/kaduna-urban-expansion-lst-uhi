...
var trainSet = withRandom.filter(
  ee.Filter.lt('random', 0.8)
);

var testSet = withRandom.filter(
...
var errorMatrix = validated.errorMatrix(
  label,
  'classification'
);
